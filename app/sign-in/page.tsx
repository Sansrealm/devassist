        ...
        <div className="hidden lg:block relative">
          <div className="relative h-full flex items-center justify-center p-8">
            ...
            <div className="relative w-full max-w-lg z-10">
              ...
              <div className="absolute top-32 right-8 bg-gradient-to-br from-[#002F71] to-[#0A4BA0] backdrop-blur-sm border border-blue-400/30 rounded-xl p-6 shadow-2xl animate-bounce transform rotate-2" style={{ animationDuration: '7s', animationDelay: '2s' }}>
